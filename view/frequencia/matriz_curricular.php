...
<table width="979" align="center">
            ...
            <table width="979" border="0" align="center" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
                <tbody><tr>
                  ...
                  <tr>
                    <td class="style11"><span class="style22"><?php echo mysql_result($rs3,$i,'d.sigladisciplina');?></span></td>
                    <td class="style11"><span class="style22"><?php echo mysql_result($rs3,$i,'d.descricao');?></span></td>
