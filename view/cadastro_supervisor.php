...
<li><a href="custos_tto.html">Custos por TTO</a></li>
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="icon-file-alt"></i> Cadastrar Supervisor</h1>
                        <h4></h4>
                    </div>
                </div>
                <!-- END Page Title -->
                            ...
                            <div class="box-content">
                              <form action="#" class="form-horizontal">
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input name="cpfSupervisor" type="text" class="input-medium" id="cpfSupervisor" placeholder="" />
                                    <span class="help-inline">Somente números</span> </div>
                                </div>
                                <div class="control-group">
                                  <label class="control-label">RG</label>
                                  <div class="controls">
                                    <input name="rgSupervisor" type="text" class="input-medium" id="rgSupervisor" placeholder="" />
                                    <span class="help-inline">Somente números</span> </div>
                                </div>
                                <div class="control-group">
                                  <label class="control-label">NOME</label>
                                  <div class="controls">
                                    <input name="nomeSupervisor" type="text" class="input-xxlarge" id="nomeSupervisor" placeholder="" />
                                  </div>
                                </div>
                                <div class="control-group">
                                  <label class="control-label"> SEXO</label>
                                  <div class="controls">
                                    <select name="sexoSupervisor" class="input-medium" tabindex="1" id="sexoSupervisor">
                                ...
                                <div class="control-group">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <input name="dataSupervisor" type="text" class="date-picker" id="dataSupervisor" value="12-02-2013" size="16" />
                                      | DATA DE NASCIMENTO
                                      <input name="nascSupervisor" type="text" class="input-medium" id="nascSupervisor" placeholder="" />
                                    </div>
                                  </div>
                                  <label class="control-label">ENDEREÇO</label>
                                  <div class="controls">
                                    <p>
                                      <input name="enderecoSupervisor" type="text" class="input-xxlarge" id="enderecoSupervisor" placeholder="" />
                                    </p>
                                    <p><span class="page-header"> | NÚMERO</span>
                                      <input name="numSupervisor" type="text" class="input-mini" id="numSupervisor" placeholder="" />
                                      | COMPLEMENTO
                                      <input name="complementoSupervisor" type="text" class="input-mini" id="complementoSupervisor" placeholder="" />
                                      | CEP
                                      <input name="cepSupervisor" type="text" class="input-medium" id="cepSupervisor" value="99.999-999" size="10" maxlength="10" placeholder="" />
                                    </p>
                                  </div>
                                </div>
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <select name="ufSupervisor" class="input-medium" tabindex="1" id="ufSupervisor">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input name="bairroSupervisor" type="text" class="input-xxlarge" id="bairroSupervisor" placeholder="" />
                                  </div>
                                </div>
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <p>
                                      <input name="cidadeSupervisor" type="text" class="input-xxlarge" id="cidadeSupervisor" placeholder="" />
                                  </div>
                                </div>
                                <div class="control-group">
                                  <label class="control-label">TELEFONE </label>
                                  <div class="controls">
                                    <input name="telefoneResidencialSupervisor" type="text" class="input-medium" id="telefoneResidencialSupervisor" placeholder="" />
                                    XX99999999 </div>
                                </div>
                                <div class="control-group">
                                  <label class="control-label">TELEFONE TRABALHO</label>
                                  <div class="controls">
                                    <input name="telefoneTrabSupervisor" type="text" class="input-medium" id="telefoneTrabSupervisor" placeholder="" />
                                    XX99999999 </div>
                                </div>
                                <div class="control-group">
                                  <label class="control-label">TELEFONE CELULAR</label>
                                  <div class="controls">
                                    <input name="celularSupervisor" type="text" class="input-medium" id="celularSupervisor" placeholder="" />
                                    XX99999999
                                ...
                                <div class="control-group">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <input name="usuarioSupervisor" type="text" class="input-xlarge" id="usuarioSupervisor" placeholder="" />
                                  ...
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="input-append">
                                        <input name="senhaSupervisor" type="password" class='input-medium' id="senhaSupervisor" placeholder="Letras e números">
                                    ...
                                    <div class="controls">
                                      <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div> <span class="btn btn-file"><span class="fileupload-new"></span><span class="fileupload-exists"></span>
                                          <input name="fotoSupervisor" type="file" class="default" id="fotoSupervisor" />
