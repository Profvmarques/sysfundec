...
<li><a href="custos_tto.html">Custos por TTO</a></li>
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="icon-file-alt"></i> Consultar Acadêmico</h1>
                        <h4>Veja a disponibilidade do acadêmico no sistema.</h4>
                    </div>
                </div>
                <!-- END Page Title -->
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li class="active"><i class="icon-home"></i> Home Consultar acadêmico</li>
                    </ul>
              </div>
                <!-- END Breadcrumb -->
                    ...
                    <div class="box">
                      ...
                      <div class="box-content">
                        <div class="btn-toolbar pull-right clearfix">
                          ...
                          <div class="btn-group"> 
                          <a class="btn btn-circle show-tooltip" title="Adicionar novo" href="#"><i class="icon-plus"></i>
                          </a> <a class="btn btn-circle show-tooltip" title="Editar selecionados" href="#"><i class="icon-edit"></i></a>
                           <a class="btn btn-circle show-tooltip" title="Excluir selecionados" href="#"><i class="icon-trash"></i></a> 
                           </div>
                          <div class="btn-group"> <a class="btn btn-circle show-tooltip" title="Imprimir" href="#"><i class="icon-print"></i></a>
                           <a class="btn btn-circle show-tooltip" title="Exportar para PDF" href="#"><i class="icon-file-text-alt"></i></a>
                            <a class="btn btn-circle show-tooltip" title="Exportar para Exel" href="#"><i class="icon-table"></i></a> </div>
                          <div class="btn-group"> <a class="btn btn-circle show-tooltip" title="Atualizar" href="#"><i class="icon-repeat"></i></a> </div>
                        </div>
                        <div class="clearfix"><div class="clearfix"><div class="control-group">
