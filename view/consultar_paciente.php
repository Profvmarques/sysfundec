...
<li><a href="custos_tto.html">Custos por TTO</a></li>
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="icon-file-alt"></i> Consultar Paciente</h1>
                        <h4>Veja a disponibilidade do Paciente no sistema.</h4>
                    </div>
                </div>
                <!-- END Page Title -->
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li class="active"><i class="icon-home"></i> Home Consultar Paciente</li>
                    </ul>
              </div>
                <!-- END Breadcrumb -->
