            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="active">
                        ...
                        <!-- BEGIN Submenu -->
                        <ul class="submenu">
                            <li><a href="cadastro_administrador.html">Administrador</a></li>
...
<li>
                        ...
                        <!-- BEGIN Submenu -->
                        <ul class="submenu">
                            <li class="active"><a href="consultar_administrador.php">administrador</a></li>
...
<li><a href="custos_tto.html">Custos por TTO</a></li>
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="icon-file-alt"></i> Cadastrar Acadêmico</h1>
                        <h4></h4>
                    </div>
                </div>
                <!-- END Page Title -->
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Cadastrar Acadêmico</li>
                    </ul>
                </div>
                <!-- END Breadcrumb -->
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i> Formulario de registro</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                                 <form action="#" class="form-horizontal">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                         <input name="cpfEstagiario" type="text" class="input-medium" id="cpfEstagiario" placeholder="" title="Campo obrigatório"/>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                         <input name="rgEstagiario" type="text" class="input-medium" id="rgEstagiario" placeholder="" title="Campo obrigatório"/>
                                         <span class="help-inline">Somente números</span>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          ...
                                          <input name="nomeEstagiario" type="text" class="input-xxlarge" id="nomeEstagiario" placeholder="" title="Campo obrigatório"/>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                         <select name="sexoEstagiario" class="input-medium" tabindex="1" id="sexoEstagiario">
                                    ...
                                    <div class="control-group">
                                      <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <input name="dataEstagiario" type="text" class="date-picker" id="dataEstagiario" value="12-02-2013" size="16" title="Campo obrigatório"/> | DATA DE NASCIMENTO
                                           <input name="nascEstagiario" type="text" class="input-medium" id="nascEstagiario" placeholder="" title="Campo obrigatório" />
                                      ...
                                      <label class="control-label">ENDEREÇO</label>
                                       <div class="controls">
                                         <p>
                                           <input name="enderecoEstagiario" type="text" class="input-xxlarge" id="enderecoEstagiario" placeholder="" title="Campo obrigatório"/>
                                         </p>
                                         <p><span class="page-header"> | NÚMERO</span>
                                           <input name="numEstagiario" type="text" class="input-mini" id="numEstagiario" placeholder="" title="Campo obrigatório"/>
                                         
                                           | COMPLEMENTO
                                           <input name="complementoEstagiario" type="text" class="input-mini" id="complementoEstagiario" placeholder="" />

   | CEP
                                           <input name="cepEstagiario" type="text" class="input-medium" id="cepEstagiario" value="99.999-999" size="10" maxlength="10" placeholder="" />
                            ...
                            <div class="control-group">
                                       ...
                                       <div class="controls">
                                         <select name="ufEstagiario" class="input-medium" tabindex="1" id="ufEstagiario">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                         <input name="bairroEstagiario" type="text" class="input-xxlarge" id="bairroEstagiario" placeholder="" />
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <p>
                                            <input name="cidadeEstagiario" type="text" class="input-xxlarge" id="cidadeEstagiario" placeholder="" />
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="controls">   
                                          <input name="telefoneResidencialEstagiario" type="text" class="input-medium" id="telefoneResidencialEstagiario" placeholder="" />
                                          XX99999999
                                      </div>
                            </div>
                                    <div class="control-group">
                                    <label class="control-label">TELEFONE TRABALHO</label>
                                     <div class="controls">   
                                          <input name="telefoneTrabEstagiario" type="text" class="input-medium" id="telefoneTrabEstagiario" placeholder="" />
                                          XX99999999
                                      </div>
                                    </div>
                                    <div class="control-group">
                                    <label class="control-label">TELEFONE CELULAR</label>
                                     <div class="controls">   
                                          <input name="celularEstagiario" type="text" class="input-medium" id="celularEstagiario" placeholder="" />
                                          XX99999999
                                    ...
                                    <div class="control-group">
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input name="usuarioEstagiario" type="text" class="input-xlarge" id="usuarioEstagiario" placeholder="" />
                                            Estagiário digite seu usuário aqui.
                                          </div>
                                        </div><div class="control-group">
                                        <label class="control-label">SENHA</label>
                                        <div class="controls">
                                            <div class="input-append">
                                                <input name="senhaEstagiario" type="password" class='input-medium' id="senhaEstagiario" placeholder="Letras e números">
                                                <span class="add-on"><i class="icon-key"></i></span>
                                            Estagiário digite sua senha aqui.
                                          </div>
                                        </div>
                                    </div>
                                      ...
                                      <div class="controls">
                                         <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <div>
                                               ...
                                               <input name="fotoEstagiario" type="file" class="default" id="fotoEstagiario" /></span>
                                               <a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remover</a>
                                            </div>
                                         </div>
                                         <span class="label label-important">NOTA!</span>
                                         <span>
                                         Imagens suportadas nas últimas versões doFirefox, Chrome, Opera, 
                                    ...
                                    <button type="submit" class="btn btn-primary" onClick="validar()"><i class="icon-ok"></i> SALVAR </button>
                                    <button type="button" class="btn">CANCELAR</button>
                                    <input nome="ok" type="hidden" id="ok"/>
                                    </div>
                                 </form>
                            </div>
                        </div>
