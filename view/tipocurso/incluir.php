...
<form class="form-horizontal" id="form" name="form" method="post">
  <table width="1010">
    <tr>
      <td width="817">&nbsp;</td>
      <td width="181"><a href="default.php?pg=view/tipocurso/consulta.php&amp;form=Consulta de Tipo de Curso"><strong><i class="icon-search"> Consultar Tipo de Curso </i></strong></a> </td>
    </tr>
  </table>
  <table width="397" border="0">
    <tr>
      ...
      <td width="218"><span class="controls">
        <input name="descricao" type="text" class="input-medium" id="descricao" placeholder="" />
      </span></td>
    </tr>
  </table>
