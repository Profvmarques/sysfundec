  ...
  <table width="397" border="0">
    <tr>
      ...
      <td width="218"><span class="controls">
        <input name="siglacurso" type="text" class="input-medium" id="siglacurso" placeholder="" value="<?php echo mysql_result($resultadoEditar,0,'siglacurso');?>"/>
      </span></td>
    </tr>
    <tr>
...
<script>
document.form.idtipocurso.value=<?php echo mysql_result($resultadoEditar,0,'idtipocurso');?>;
</script>