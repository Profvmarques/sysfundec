...
<form class="form-horizontal" id="form" name="form" method="post">
  <table width="684" border="0" align="center">
    ...
    <tr>
      <td>EVENTO LETIVO </td>
      <td>
        <input name="descricao" type="text" class="input-xlarge" id="descricao" placeholder="" value="<?php echo mysql_result($rs8,0,'descricao');?>"/>     </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <select name="idtipoevento" class="input-xlarge" id="idtipoevento" title="O campo curso é obrigatório">
...
<script>
document.form.idperiodoletivo.value='<?php echo mysql_result($rs8,0,'idperiodoletivo');?>';
document.form.idtipoevento.value='<?php echo mysql_result($rs8,0,'idtipoevento');?>';
</script>