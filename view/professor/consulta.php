								...
								<table width="100%" class="table table-advance" id="table1">
								  ...
								  <?php for($i=0;$i<$linha;$i++){?>
                                    <tr class="table-flag-blue">
                                      ...
                                      <td><a title="Visualizar" href="default.php?pg=view/professor/visualizar.php&form=VISUALIZAÇÃO DOS DADOS DO PROFESSOR&id=<?php echo mysql_result($rs,$i,'p.idpessoas');?>"><i class="icon-eye-open"></i>Visualizar</a></td>
                                    </tr>
									<?php }?>
                                  </tbody>
                                </table>
										...
										<div class="alert alert-error">
                                            ...
                                            <h4>Mensagem!</h4>
                                            <p>Nenhum registro encontrado <center> <h4><a href="default.php?pg=view/professor/incluir.php&form=Cadastro de Professor"><strong> <i class="icon-plus-sign">  Cadastrar novo Professor</i> </strong></a></h4></center></p>
                                        </div>
										<?php }?>
								<br />
								<br />
