...
<form class="form-horizontal" id="form" name="form" method="post">
  ...
  <table width="775" border="0" align="center" cellpadding="2" cellspacing="4">
    ...
    <tr class="linhas0">
      <td><input name="matricula" type="text" id="matricula" size="20" class="input-medium"/></td>
      <td><input name="ch" type="text" id="ch" size="10" class="input-mini" />        
      HORAS</td>
      <td><input name="dtini" type="text" class="input-medium" id="dtini" onkeypress="return Mascaras_Format(document.form,'dtini','99/99/9999',event);" value="" size="20" maxlength="10" onblur="return valida_data1(document.form.dtini,5);"/>
      ...
      <td><input name="dtfim" type="text" class="input-medium" id="dtfim" onkeypress="return Mascaras_Format(document.form,'dtfim','99/99/9999',event);" value="" size="20" maxlength="10" onblur="return valida_data1(document.form.dtfim,5);"/>
