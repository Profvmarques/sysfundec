...
Processo('incluirAtividadeFuncional');
?>
<form class="form-horizontal" id="form" name="form" method="post">
  ...
  <table width="714" border="0" align="center" cellpadding="2" cellspacing="4">
    ...
    <tr class="linhas">
      ...
      <td><input name="data_inicio" type="text" id="data_inicio" size="20" class="input-medium" value="<?php echo $_POST['data_inicio']; ?>" onkeypress="return Mascaras_Format(document.form,'data_inicio','99/99/9999',event);" maxlength="10" onblur="return valida_data1(document.form.data_inicio,5);" />
      <a title="Calendário" onclick="selectDate('form','data_inicio')"><img src="img/calendar.gif" width="18" height="18" /></a></td>
      <td width="191"><input name="data_termino" type="text" id="data_termino" size="20" class="input-medium" value="<?php echo $_POST['data_termino']; ?>" onkeypress="return Mascaras_Format(document.form,'data_termino','99/99/9999',event);" maxlength="10" onblur="return valida_data1(document.form.data_termino,5);"/>
...
<script>
document.form.idfuncao.value='<?php echo $_POST['idfuncao']; ?>';
</script>