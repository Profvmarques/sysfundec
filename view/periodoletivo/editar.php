...
<form class="form-horizontal" id="form" name="form" method="post">
  ...
  <table width="844" border="0">
    ...
    <tr>
      ...
      <td><span class="controls">
        <input name="data_fim" type="text" class="input-medium" id="data_fim" onkeypress="return Mascaras_Format(document.form,'data_fim','99/99/9999',event);" size="20" maxlength="10" onblur="return valida_data1(document.form.data_fim,5);" value="<?php echo mysql_result($rs2,0,'dtfim');?>"  title="O campo data de término é obrigatório"/>
...
<script>document.form.siglacurso.value='<?php echo mysql_result($rs2,0,'siglacurso');?>';</script>