...
<legend style="border: 1px solid #000000; background:#FFFFFF"> LANÇAMENTO DE NOTAS / FALTAS        </legend>
  ...
  <div style="margin-left:15px; background:#AECEF4">
    <table width="723" border="0" align="center">
      <tr>
        <td width="321"><strong>CURSO </strong></td>
      ...
      <tr>
        <td width="321"><strong>PERÍODO LETIVO </strong></td>
        <td width="392"><select name="idperiodoletivo" class="input-medium" id="idperiodoletivo" title="O campo período letivo é obrigatório">
          <option value="">Escolha o tipo de curso</option>
          <option value="" selected="selected">Aguardando ...</option>
        </select></td>
      </tr>
      <tr>
        <td width="321"><strong>SELECIONE A MATRÍCULA </strong></td>
    ...
    <div class="alert alert-error">
      ...
      <h4>Mensagem!</h4>
      <p>Professor(a) <b><?php echo $_SESSION['professor'];?></b> não esta alocada em nenhuma turma do período selecionado! </p>
      <center>
        <h4>&nbsp;</h4>
      </center>
    </div>
