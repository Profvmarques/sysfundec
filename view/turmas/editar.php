  ...
  <table width="787" border="0">
    ...
    <tr>
      ...
      <td>
        ...
        <span class="style1">Esolha o Curso novamente para carregar o Período Letivo</span> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><select name="matriculaprofessor" class="input-xxlarge" id="matriculaprofessor" title="O campo professor é obrigatório">
        ...
        <option value="<?php echo mysql_result($rs7,$i,'mp.matriculaprofessor');?>"><?php echo "Matrícula : ".mysql_result($rs7,$i,'mp.matriculaprofessor')." - ".utf8_encode(mysql_result($rs7,$i,'p.nome'))." ".mysql_result($rs7,$i,'mp.carga_horaria')."h";?></option>
        <?php }?>
      </select></td>
    </tr>
    <tr>
