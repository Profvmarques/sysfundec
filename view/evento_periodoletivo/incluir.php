...
<form class="form-horizontal" id="form" name="form" method="post">
  <table width="1010">
    <tr>
      <td width="817">&nbsp;</td>
      <td width="181"><a href="default.php?pg=view/periodoletivo/consulta.php&form=Consulta de Período Letivo"><strong><i class="icon-search"> Consultar Evento Letivo </i></strong></a> </td>
    </tr>
  </table>
  <table width="844" border="0">
    ...
    <tr>
      <td width="174">EVENTO LETIVO </td>
      <td width="508"><select name="idperiodoletivo" class="input-medium" id="idperiodoletivo" title="O campo evento letivo é obrigatório">
    ...
    <tr>
      ...
      <td><select name="idtipoevento" class="input-medium" id="idtipoevento" title="O campo evento letivo é obrigatório">
        <?php for($i=0;$i<$linha7;$i++){ ?>
        <option value="<?php echo mysql_result($rs7,$i,'p.idperiodoletivo');?>"><?php echo utf8_encode(mysql_result($rs7,$i,'p.siglaperiodo'));?></option>
        <?php } ?>
      </select></td>
