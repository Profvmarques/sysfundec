...
<form class="form-horizontal" id="form" name="form" method="post">
  <table width="1010">
    <tr>
      <td width="610">&nbsp;</td>
      <td width="388"><a href="default.php?pg=view/adm_modulos/consulta.php&amp;form=Consulta de Módulos"><strong><i class="icon-search"> Consultar Funcionário do Apoio Administrativo  </i></strong></a> </td>
    </tr>
  </table>
